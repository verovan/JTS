...
function add_command_blockip() {
    ...
    cp commands/manpages/blockip $mp/man8/blockip.8
...
# Montar un nuevo proyecto/laboratorio
function add_command_addlab() {
    cp commands/addlab /sbin
    cp commands/rmlab /sbin
    chmod +x /sbin/addlab
    chmod +x /sbin/rmlab
}


# Agregar laboratorio web enjaulado
function add_command_newlab() {
    add_command_addlab
    tar -xzvf commands/newlab.tar.gz
    ./newlab/installer.py
}
